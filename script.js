...
task8.innerHTML = `Вариант решения №1. Дана строка: <br> ${string} <br> Общее число символов в ней:
 ${charCount}<br>
...
// Задача №8. Второй вариант решения.
let string2 = '"Перелистай страницы жизни вслух прочти одну из них. Что в них найдешь ты? Отзвук тризны Иль кровью напоенный стих?"'.toLowerCase() 
let charCount2 = Array.from(string2).length;

 const vowelRe = /[аеёиоуыэюя]/;
 
 const countVowels = string2.split('').reduce((acc, c) => {
 ...
 ${charCount2}<br>
 Буква А - ${(countVowels['а'] === undefined) ? 'Ничегошеньки' : countVowels['а']} из ${charCount2} символов <br>
 Буква Е - ${(countVowels['е'] === undefined) ? 'Ничегошеньки' : countVowels['е']} из ${charCount2} символов <br>
 Буква Ё - ${(countVowels['ё'] === undefined) ? 'Ничегошеньки' : countVowels['ё']} из ${charCount2} символов <br>
 Буква И - ${(countVowels['и'] === undefined) ? 'Ничегошеньки' : countVowels['и']} из ${charCount2} символов <br>
 Буква О - ${(countVowels['о'] === undefined) ? 'Ничегошеньки' : countVowels['о']} из ${charCount2} символов <br>
 Буква У - ${(countVowels['у'] === undefined) ? 'Ничегошеньки' : countVowels['у']} из ${charCount2} символов <br>
 Буква Ы - ${(countVowels['ы'] === undefined) ? 'Ничегошеньки' : countVowels['ы']} из ${charCount2} символов <br>
 Буква Э - ${(countVowels['э'] === undefined) ? 'Ничегошеньки' : countVowels['э']} из ${charCount2} символов <br>
 Буква Ю - ${(countVowels['ю'] === undefined) ? 'Ничегошеньки' : countVowels['ю']} из ${charCount2} символов <br>
 Буква Я - ${(countVowels['я'] === undefined) ? 'Ничегошеньки' : countVowels['я']} из ${charCount2} символов <br>`